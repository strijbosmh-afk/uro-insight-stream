...
export const Route = createFileRoute("/sources_/")({
  head: ({ params }) => ({
    meta: [
      { title: `@${params.handle} — Source spotlight — UroFeed` },
      {
        name: "description",
        content: `Bio, recent posts, themes, and group memberships for @${params.handle}.`,
      },
    ],
  }),
...
function SourceSpotlightPage() {
  ...
  // Untracked source state — render the "Track this source" CTA.
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-3 flex items-center gap-x-4 gap-y-1 text-[11px] font-mono text-text-muted flex-wrap">
                ...
                <span>
                  enriched{" "}
                  <span title={src.enriched_at ?? "never"}>
                    {relativeAge(src.enriched_at)}
                  </span>
                </span>
              </div>
